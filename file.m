function lab_06
    ...
    subplot(2,1,1);
    plot(t, x1, 'g', t, x0, 'b');
    title('Исходный сигнал с гауссовой помехой');
    legend('Гауссовая помеха','Исходный сигнал');

    subplot(2,1,2);
    plot(t, ifft(fft(x1).*y1))

    title('Фильтрация сигнала Гаусса фильтром Винера');
    legend('Восстановленный сигнал');

    figure(2)
    subplot(2,1,1);
    plot(t, x2, 'g', t, x0, 'b');
    title('Исходный сигнал с импульсной помехой');
    legend('Импульсная помеха','Исходный сигнал');
